<section class="relative min-h-screen bg-[#0A1E13] flex items-center justify-center overflow-hidden"
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 w-full pt-36 sm:pt-40 lg:pt-44 pb-24 sm:pb-28">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            <div class="lg:col-span-7 space-y-8 text-center lg:text-left">
                ...
                <p class="text-slate-100 text-sm sm:text-base lg:text-[17px] max-w-2xl mx-auto lg:mx-0 leading-relaxed font-sans font-light opacity-0 animate-[fadeInUp_1s_0.9s_cubic-bezier(0.16,1,0.3,1)_forwards]" style="color: #f1f5f9 !important;">
                ...
                <div class="grid grid-cols-3 gap-6 pt-8 border-t border-white/10 max-w-xl mx-auto lg:mx-0 opacity-0 animate-[fadeInUp_1s_1.5s_cubic-bezier(0.16,1,0.3,1)_forwards]">
                    <div class="text-center lg:text-left">
                        ...
                        <p class="text-2xl sm:text-3xl font-bold text-[#C5A880] font-serif tracking-tight">
    ...
    <div class="absolute bottom-6 left-1/2 -translate-x-1/2 z-20 flex items-center gap-3 w-full justify-center">
        <template x-for="i in totalSlides" :key="i">
            <button @click="currentSlide = i - 1; clearInterval(interval); interval = setInterval(() => { currentSlide = (currentSlide + 1) % totalSlides }, 6000)"
                    class="relative cursor-pointer group h-8 flex items-center bg-transparent border-none outline-none">
